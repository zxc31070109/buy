...
const GOOGLE_SHEET_URL = 'https://docs.google.com/spreadsheets/d/1dp6_yz-AW9KtLX_md2CsmT4e9dE8Y1zYV_3awuxM8ss/edit?usp=sharing';
...
export default function App() {
  ...
  // 加入/增加型號
  const handleAddItemFromPriceTable = (item: any) => {
  ...
  // 一鍵複製 LINE 喊單確認文字
  const handleCopyLineReply = (order: any) => {
    const itemsText = order.items.map((i: any) => `${i.code} × ${i.qty}`).join(', ');
  ...
  const filteredOrders = useMemo(() => {
    return orders.filter((o: any) => {
      const matchSearch =
        ...
        o.items.some((i: any) => i.code.toLowerCase().includes(orderSearchText.toLowerCase()));
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5 pt-1">
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl bg-slate-700 text-slate-200 text-xs hover:bg-slate-600 active:scale-95 cursor-pointer"
                      title="編輯此單"
                    >
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl bg-rose-500/20 text-rose-300 border border-rose-500/30 text-xs hover:bg-rose-500/30 active:scale-95 cursor-pointer"
                      title="刪除"
                    >
              ...
              {priceTable.map((item: any) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="p-2 text-slate-500 hover:text-rose-400 active:scale-95 cursor-pointer"
                  >
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-slate-900/95 backdrop-blur-lg border-t border-slate-800 px-3 pt-2 pb-5">
        <div className="max-w-md mx-auto grid grid-cols-4 gap-1">
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center py-1.5 rounded-xl relative transition-all cursor-pointer ${
              currentTab === 'orders'
